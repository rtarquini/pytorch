...
class AliasDb {
 public:
  ...
  bool moveAfterTopologicallyValid(Node* movePoint, Node* n);
  bool moveBeforeTopologicallyValid(Node* movePoint, Node* n);

  bool couldMoveAfterTopologically(Node* movePoint, Node* n);
  bool couldMoveBeforeTopologically(Node* movePoint, Node* n);
